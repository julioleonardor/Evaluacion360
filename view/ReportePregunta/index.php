    ...
    <div class="br-mainpanel">
        ...
        <div class="br-section-wrapper">
            ...
            <div class="table-wrapper">
              <table id="reportePregunta_data" class="table display responsive nowrap">
                <thead>
                  <tr>
                    <th class="wd-5p">Codigo</th>
                    <th class="wd-35p">Evaluado</th>
                    <th class="wd-35p">Competencia</th>
                    <th class="wd-10p">Pregunta</th>
                    <th class="wd-30p">Evaluador</th>
                    <th class="wd-10p">Puntuacion</th>
                  </tr>
                </thead>
                <tbody>
        ...
        <script type="text/javascript" src="reportepregunta.js"></script>
</body>
