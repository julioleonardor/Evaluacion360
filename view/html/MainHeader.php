            ...
            <div class="dropdown">
                <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                    <span class="logged-name hidden-md-down">
                        <?php echo $_SESSION["name_user"]?></br>
                ...
                <input type="hidden" id="id_userx" value="<?php echo $_SESSION["id_user"] ?>">
                
                <input type="hidden" id="name_userx" value="<?php echo $_SESSION["name_user"] ?>">
