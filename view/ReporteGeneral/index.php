    ...
    <div class="br-mainpanel">
        <div class="br-pageheader pd-y-15 pd-l-20">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                <a class="breadcrumb-item" href="#">HReporte General</a>
            </nav>
        </div>
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5">Evaluacion 360</h4>
            <p class="mg-b-0">Pantalla Reporte General</p>
        </div>
        ...
        <div class="br-section-wrapper">
            ...
            <div class="table-wrapper">
              <table id="reporteGeneral_data" class="table display responsive nowrap">
                <thead>
                  <tr>
                    <th class="wd-5p">Codigo</th>
                    <th class="wd-35p">Evaluado</th>
                    <th class="wd-35p">Departamento</th>
        ...
        <script type="text/javascript" src="reportegeneral.js"></script>
</body>
